    ...
    <div class="body-main">
            <div class="head-lavel">
                <div class="table-button">
                    <el-button type="info" icon="plus" @click="">分配用户权限</el-button>
                </div>
            ...
            <div>
                <el-table :data='tableData' border style="width: 100%">
                    <el-table-column prop='staff' label='用户' sortable='custom'>
...
<script>
    import {getStaffPermissions, postStaffPermissions, putStaffPermissions, deleteStaffPermissions} from 'api/permission';
...
//                    name__contains: this.searchdata
                ...
                getStaffPermissions(parms).then(response => {
            ...
            addGroupSubmit(formdata) {
                postStaffPermissions(formdata).then(response => {
                    this.$message({
                        message: '恭喜你，添加成功',
                        type: 'success'
                    });
            ...
            deleteGroup(id){
                deleteStaffPermissions(id).then(response => {
                    this.$message({
                        message: '恭喜你，删除成功',
                        type: 'success'
                    });
